...
vignette: >
  %\VignetteIndexEntry{ARLClustering - Testing WordAdjacency dataset}
...
- Graph Label    : Word Adjacency Network
- Total Nodes    : 425
- Total Edges    : 112
- Average Degree : 7.589286
...
Next, we generate transactions from the graph, with a total rows of 102
...
- The Minimum Support    : 0.03
- The Minimum Confidence : 0.5
- The Lift               : 20.4
- The Gross Rules length : 649
- The selection Ratio    : 6
...
We use the obtained parameters to generate gross rules, where we obtain 649 rules.
...
We filter out redundant rules from the generated gross rules. Next, we filter out non-significant rules from the non-redundant rules, and we obtain the 528 rule items.
