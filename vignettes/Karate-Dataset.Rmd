...
vignette: >
  %\VignetteIndexEntry{ARLClustering - Testing Karate dataset}
...
- The Lift               : 7
- The Gross Rules length : 66
- The selection Ratio    : 2
...
# Display the total number of clusters and the total processing time
cat("Clearing rules Processing Time: ", t5["elapsed"], " seconds\n")
```
